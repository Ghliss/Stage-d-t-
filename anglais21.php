...
<body>
 ...
 <div><h1 align="center">Niveau1</h1>
    <h5>(5 pts)</h5>
         ...
         <?php
if (isset($_POST["envoyer"])&& isset($_POST["question2"])&& isset($_POST["question3"]) && isset($_POST["question1"]) && isset($_POST["question4"]) && isset($_POST["question5"]) && $_POST["question1"]=="q1rep1"  && $_POST["question1"]=="q2rep2" && $_POST["question3"]=="q3rep2" && $_POST["question4"]=="q4rep2" && $_POST["question5"]=="q5rep2")
{?>

   <center><input type="submit" name="niveau" value="niveau2" id="btnqq" onclick="window.location.href='anglais22.php';" ></center> 
    <?php } ?>
