 ...
 try
        ...
        $reponse=$bdd->query('SELECT * FROM etudiants WHERE classe=\'II1A\'  ') ;
    ...
    $reponse->closeCursor() ;
      $reponse=$bdd->query('SELECT * FROM etudiants WHERE classe=\'II1B\'  ') ;
       while($entree=$reponse->fetch() )
    {
        echo"<tr><td>".$entree['nom']."</td><td>".$entree['prenom']."</td><td>".$entree['classe']."</td><td>".$entree['note_php_niv1']."</td><td>".$entree['note_php_niv2']."</td></tr>" ;
    }
    $reponse->closeCursor() ;
    $reponse=$bdd->query('SELECT * FROM etudiants WHERE classe=\'II1C\'  ') ;
       while($entree=$reponse->fetch() )
    {
        echo"<tr><td>".$entree['nom']."</td><td>".$entree['prenom']."</td><td>".$entree['classe']."</td><td>".$entree['note_php_niv1']."</td><td>".$entree['note_php_niv2']."</td></tr>" ;
    }
    $reponse->closeCursor() ;
    $reponse=$bdd->query('SELECT * FROM etudiants WHERE classe=\'II1D\'  ') ;
       while($entree=$reponse->fetch() )
    {
        echo"<tr><td>".$entree['nom']."</td><td>".$entree['prenom']."</td><td>".$entree['classe']."</td><td>".$entree['note_php_niv1']."</td><td>".$entree['note_php_niv2']."</td></tr>" ;
    }
    $reponse->closeCursor() ;
    $reponse=$bdd->query('SELECT * FROM etudiants WHERE classe=\'II1E\'  ') ;
       while($entree=$reponse->fetch() )
    {
        echo"<tr><td>".$entree['nom']."</td><td>".$entree['prenom']."</td><td>".$entree['classe']."</td><td>".$entree['note_php_niv1']."</td><td>".$entree['note_php_niv2']."</td></tr>" ;
    }
    $reponse->closeCursor() ;
    $reponse=$bdd->query('SELECT * FROM etudiants WHERE classe=\'II1F\'  ') ;
       while($entree=$reponse->fetch() )
    {
        echo"<tr><td>".$entree['nom']."</td><td>".$entree['prenom']."</td><td>".$entree['classe']."</td><td>".$entree['note_php_niv1']."</td><td>".$entree['note_php_niv2']."</td></tr>" ;
    }
